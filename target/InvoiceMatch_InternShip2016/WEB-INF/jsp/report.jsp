...
<body>
	...
	<div class="panel col-sm-12">
		<div class="panel-heading">
			<img src="images/logo.png" class="image-header">
		</div>
	...
	<div style="margin-top: -10px">
		...
		<div class="navbar-header">
			...
			<a href="/InvoiceMatch_InternShip2016"
				class="navbar-brand glyphicon glyphicon-home"></a>
		</div>
	...
	<div class="container-fluid container-override">
		...
		<div class="panel panel-primary">
			...
			<div class="panel-heading" data-toggle="collapse"
				...
				<span class="accordion-toggle-bdm"> <i
					id="fa-angle-double-down-style" class="fa fa-angle-double-down"
					style="width: 15px;"></i> Report
				</span>
			</div>

			<div id="searchReportForm"
				class="row collapse in container-fluid container-override">
				...
				<div class="panel-body">
					...
					<div class="form-horizontal">
						...
						<div class="form-group">
							<label for="invStat" class="col-sm-2 control-label"
								style="text-align: left">Invoice Status</label>
						...
						<div class="form-group">
							<label for="datepicker" class="col-sm-2 control-label"
								style="text-align: left; margin-top: 10px">Invoice Date
								Range</label>
							...
							<div class="col-sm-3 margin">
								<div class="input-group input-append date " id="datepicker2">
									<input type="text" class="form-control" name="date" id="dayEnd" />
				...
				<div class="form-inline margin_right_btn" style="float: right">
					<button id="btClean" type="button"
						class="btn btn-default cleanButton">
						<span class="glyphicon glyphicon-refresh"></span>&nbsp;&nbsp;Clear
					</button>
					<button id="btSearch" type="button" class="btn searchButton">
		...
		<div>
			<div class="row no-right-padding searchResultMargin"
				id="searchResult">
				<div class="col-md-2">
